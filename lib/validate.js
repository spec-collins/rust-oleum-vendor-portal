/**
 * Vendor response choices. Keep codes stable once links/emails go out.
 */
export const CHOICES = ['spreadsheet', 'upload_docs', 'specright', 'assisted'];
...
export function validateSubmission(input) {
  ...
  if (stage !== 'choice' && stage !== 'timeframe' && stage !== 'reset') {
    return { ok: false, error: 'stage must be "choice", "timeframe", or "reset".' };
  }
